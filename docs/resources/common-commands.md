...
$ pwd                       # make sure you are in the `ae199-YEAR-SEMESTER` directory
$ git clone <repo-link>     # clone the repo to your local machine
$ cd <labXX-name-githubid>  # change into the repo
...
# create a PR to have your partner review your code before merging into your master branch
#   1. navigate to your GitHub lab repo in a web browser
...
# merge your feature branch into your master branch through GitHub
# delete the feature branch (on GitHub) after it is successfully merged
$ git checkout master  # check out your master branch to update it
$ git pull origin master  # pull changes from GitHub, addressing any conflicts that may arise
$ git branch -d feature-<name>  # delete your local feature branch
```
...
$ pwd               # make sure you are in the repo directory
